...
class YahtzeeServerTest {
    ...
    @Test
    void shouldGetReceiveResultFromLargeStraightCategory() {
        List<Integer> scoreOfThrow = Arrays.asList(2, 6, 3, 5, 4);
    ...
    @Test
    void shouldGetReceiveResultFromFullHouseCategory() {
        List<Integer> scoreOfThrow = Arrays.asList(1, 1, 2, 2, 2);
